  ...
  return (
    <div>
      <div class="flex bg-white">
        ...
        <main class="min-h-screen bg-white border-l">
          <nav class="flex items-center justify-between bg-white border-b">
            <div class="flex items-center bg-gray-100 py-2 rounded-md  w-full">
              <input
                type="text"
                placeholder="search"
            ...
            <div class="shadow-lg rounded-t-md overflow-hidden ">
              <div class="">
                ...
                <div class="p-2 relative">
                  ...
                  <img
                    class="h-12 w-12 rounded-full absolute -top-6 p-0.5 border-2 right-6"
                    src="https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80"
                    alt=""
                  />
                </div>

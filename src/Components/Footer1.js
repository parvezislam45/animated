...
const Footer1 = () => {
  return (
    <div className="bg-gray-900 px-20">
      <footer className="footer p-10 bg-gray-900 text-white mt-10">
        <nav>
          <img
        ...
        <nav>
          ...
          <a className="link link-hover">Crash</a>
          <a className="link link-hover">Double</a>
          <a className="link link-hover">Blaze Mirror</a>
          <a className="link link-hover">Fairness</a>
          <a className="link link-hover">VIP Club</a>
        </nav>
        <nav>
      ...
      <div className="flex flex-col sm:flex-row justify-start items-center gap-4 sm:gap-20">
        ...
        <div>
          <p className="text-sm">
            Prolific Trade N.V. is licensed and regulated by Antillephone N.V,
            under License No 8048/JAZ2024-009
          </p>
          <p className="text-sm">
      ...
      <p className="text-center text-xs">Support support@blaze.com | Partners partners@blaze.com | Legal legal@blaze.com | Press press@blaze.com</p>
    </div>
  );
};
